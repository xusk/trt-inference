...
bool Int8EntropyCalibrator::getBatch(void *bindings[], const char *names[], int nbBindings) TRT_NOEXCEPT {
...
const void *Int8EntropyCalibrator::readCalibrationCache(size_t &length) TRT_NOEXCEPT {
...
void Int8EntropyCalibrator::writeCalibrationCache(const void *cache, size_t length) TRT_NOEXCEPT {
